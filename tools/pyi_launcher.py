"""PyInstaller entrypoint for the Murmuro.app bundle.
...
PyInstaller at `src/murmuro/__main__.py`, we point it here — this file
...
~/Library/Logs/Murmuro/ so anything that bypasses our logger (Qt warnings,
...
def _redirect_streams_when_bundled() -> None:
    ...
    if not getattr(sys, "frozen", False):
        return
    log_dir = Path.home() / "Library" / "Logs" / "Murmuro"
    log_dir.mkdir(parents=True, exist_ok=True)
    raw = log_dir / "murmuro.stderr.log"
...
from murmuro.__main__ import main  # noqa: E402
